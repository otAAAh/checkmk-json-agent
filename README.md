...
```sh
mkp add json_api-0.4.0.mkp
mkp enable json_api 0.4.0
```
...
translation fall back to English. Currently shipped: **German (`de`)**. Service
...
```
locales/
  de/LC_MESSAGES/multisite.po      # German translation (committed source of truth)
